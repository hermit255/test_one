...
class GetTicketClassService
{
    ...
    public function __invoke (int $ticketClassId, TicketClassRepository $ticketClass) {
        $ticketClassObject = $ticketClass->getById($ticketClassId);
        $titles = [];
